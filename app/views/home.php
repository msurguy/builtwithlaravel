...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
		...
		<link rel="stylesheet" href="bootstrap/bootstrap-2.3.1.css">
		<link rel="stylesheet" href="bootstrap/bootstrap-responsive-2.3.1.css">
		...
		<div class="navbar navbar-static-top">
              <div class="navbar-inner">
                <div class="container">
                  ...
                  <img class="logo" src="assets/images/laravel.png" width="70" height="20" alt="Built with Laravel">
					...
					<ul class="media-list">
						<li class="media">
							<a class="pull-left" href="#">
								<img class="media-object" src="http://placehold.it/250x125">
							</a>
							<div class="media-body">
								<p class="media-heading lead">Media heading</p>
